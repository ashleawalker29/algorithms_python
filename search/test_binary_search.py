...
class BinarySearchTests(unittest.TestCase):
    ...
    def test_binary_search_nums_positive_sorted(self):
        self.assertEqual(binary_search([12, 19, 20, 45, 55, 91], 20),
                         'Value was found within the list.')
        self.assertEqual(binary_search([12, 19, 20, 45, 55, 91], 72),
    ...
    def test_binary_search_nums_negative_sorted(self):
        self.assertEqual(binary_search([-91, -55, -45, -20, -19, -12], -45),
                         'Value was found within the list.')
        self.assertEqual(binary_search([-91, -55, -45, -20, -19, -12], -72),
                         'Value was not found within the list.')
    ...
    def test_binary_search_nums_positive_and_negative_sorted(self):
        self.assertEqual(binary_search([-20, -19, -12, 45, 55, 91], 45),
                         'Value was found within the list.')
        self.assertEqual(binary_search([-20, -19, -12, 45, 55, 91], 72),
                         'Value was not found within the list.')
        self.assertEqual(binary_search([-20, -19, -12, 45, 55, 91], -12),
                         'Value was found within the list.')
        self.assertEqual(binary_search([-20, -19, -12, 45, 55, 91], -72),
                         'Value was not found within the list.')
