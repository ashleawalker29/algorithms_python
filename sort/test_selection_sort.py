...
class SelectionSortTests(unittest.TestCase):
    ...
    def test_selection_sort_nums_positive_even(self):
        self.assertEqual(selection_sort([20, 12, 45, 19, 91, 55]), [12, 19, 20, 45, 55, 91])

    def test_selection_sort_nums_positive_odd(self):
        self.assertEqual(selection_sort([20, 12, 45, 19, 91]), [12, 19, 20, 45, 91])

    def test_selection_sort_nums_negative_even(self):
        self.assertEqual(
            selection_sort([-20, -12, -45, -19, -91, -55]), [-91, -55, -45, -20, -19, -12])

    def test_selection_sort_nums_negative_odd(self):
        self.assertEqual(
            selection_sort([-20, -12, -45, -19, -91]), [-91, -45, -20, -19, -12])

    def test_selection_sort_nums_positive_and_negative_even(self):
        self.assertEqual(selection_sort([-12, -19, -20, 45, 91, 55]), [-20, -19, -12, 45, 55, 91])
